...
public class Property {
    ...
    public boolean equals(Object other) {
        ...
        return (((((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name)))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.displayMode == rhs.displayMode)||((this.displayMode!= null)&&this.displayMode.equals(rhs.displayMode))))
